...
function GuestView() {
    ...
    if (query === "") {
      ...
      setFilteredSessions(
        sessions.filter((session) =>
          session.text.toLowerCase().includes(query.toLowerCase()),
        ),
      );
    }
  }, [query, sessions]);
  ...
  const displayedSessions = query ? filteredSessions : [];
  ...
  return (
    <div>
      <header className="navbar">
        ...
        <div>
          <a href="/login.html" className="nav-button">
            Log in
          </a>
          <a href="/register.html" className="nav-button">
            Sign up
          </a>
        </div>
      </header>
